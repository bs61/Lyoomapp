...
//   String _error;
//   final String _currentSecret = "sk_test_51HTRGrJDDJWzOBtrRqT4gdqe6Eh2MSYmlPcCBkwnDwpodL4U8msQLGHMKNuXjdWc766MPGtdoYVpSsEwsQBea3cz00kIyb37Ip "; //set this yourself, e.g using curl
...
//         StripeOptions(publishableKey: "pk_test_51HTRGrJDDJWzOBtrWLhdzMDN5roWRctfWm2Vh7Dj3D46jr4JVUI2itmuOJn7gHslPqNO6ckPNs0dC0shzfEo4w0v00kztvKiN7",
//             merchantId: "Test",
//             androidPayMode: 'test'));
//   }
//
...
Future<String> payViaNewCard(BuildContext context,String amount) async {
  ...
  Scaffold.of(context).showSnackBar(
      SnackBar(
        ...
        duration: new Duration(milliseconds: response.success == true ? 1200 : 10000),
      )
